...
export default function BoardPage() {
  ...
  const filteredItems = data.items.filter((item) => {
    ...
    if (selectedCategory === 'unanswered') {
      // Swagger 정의: 사용자 답변이 없는 모든 질문 (AI 유무 무관)
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-6 pt-3 pb-2">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 mb-2">질문 게시판</h1>
              <p className="text-gray-600">궁금한 점을 찾아보고, 없다면 바로 질문을 남겨보세요.</p>
            </div>
